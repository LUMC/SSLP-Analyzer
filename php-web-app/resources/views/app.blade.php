...
<div class="w-full bg-blue-900">
    <img src="gfx/LUMC.alpha.png" alt="Leiden University Medical Center logo" class="">
</div>
<div class="flex bg-blue-900 pb-4">
    <div class="mx-auto">
        ...
        <div class="flex mt-4 justify-between text-sm text-blue-200">
            ...
            <div>
                <a href="https://github.com/LUMC/SSLP-Analyzer/" target="_blank">
                    <svg class="h-full fill-current" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
