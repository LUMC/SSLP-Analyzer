...
@endfor
                            <div class="py-2 sm:px-1 md:px-2 first:pl-0 last:pr-0">
                                <select name="population" id="population" wire:model.defer="sPopulation" class="rounded-md p-2 sm:px-2 md:px-4 bg-sky-100 shadow-sm ring-1 ring-inset ring-sky-300 sm:text-sm md:text-base @error('sPopulation') bg-rose-300 ring-red-600 @enderror">
